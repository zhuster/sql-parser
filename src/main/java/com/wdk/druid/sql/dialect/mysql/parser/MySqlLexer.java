...
import com.wdk.druid.sql.parser.CharTypes;
import com.wdk.druid.sql.parser.Keywords;
import com.wdk.druid.sql.parser.Lexer;
import com.wdk.druid.sql.parser.NotAllowCommentException;
import com.wdk.druid.sql.parser.ParserException;
import com.wdk.druid.sql.parser.SQLParserFeature;
import com.wdk.druid.sql.parser.SymbolTable;
...
public class MySqlLexer extends Lexer {
    ...
    public MySqlLexer(String input, boolean skipComment, boolean keepComments){
        ...
        this.skipComment = skipComment; //根据mysql的特性设置是否忽略注释，todo 这个地方也很冗余
        this.keepComments = keepComments;
        super.keywods = DEFAULT_MYSQL_KEYWORDS;//用mysql的关键字+公用的默认关键字覆盖父类的默认关键字
    }
