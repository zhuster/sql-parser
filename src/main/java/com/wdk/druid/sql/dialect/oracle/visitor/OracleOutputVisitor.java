 ...
 */
package com.wdk.druid.sql.dialect.oracle.visitor;

import java.util.List;

import com.wdk.druid.sql.ast.SQLArgument;
import com.wdk.druid.sql.ast.SQLDataType;
import com.wdk.druid.sql.ast.SQLExpr;
import com.wdk.druid.sql.ast.SQLHint;
...
import com.wdk.druid.sql.ast.expr.SQLBetweenExpr;
...
import com.wdk.druid.sql.ast.expr.SQLMethodInvokeExpr;
...
import com.wdk.druid.sql.ast.statement.SQLCheck;
...
import com.wdk.druid.sql.ast.statement.SQLJoinTableSource;
import com.wdk.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
import com.wdk.druid.sql.ast.statement.SQLRollbackStatement;
import com.wdk.druid.sql.ast.statement.SQLSavePointStatement;
import com.wdk.druid.sql.ast.statement.SQLScriptCommitStatement;
...
import com.wdk.druid.sql.ast.statement.SQLTruncateStatement;
import com.wdk.druid.sql.ast.statement.SQLUnique;
import com.wdk.druid.sql.ast.statement.SQLWithSubqueryClause;
import com.wdk.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.wdk.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.wdk.druid.sql.dialect.oracle.ast.clause.CycleClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.OracleStorageClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import com.wdk.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.SampleClause;
import com.wdk.druid.sql.dialect.oracle.ast.clause.SearchClause;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleAnalytic;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import com.wdk.druid.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCheck;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleConstraint;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleForStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleUnique;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import com.wdk.druid.sql.dialect.oracle.parser.OracleFunctionDataType;
import com.wdk.druid.sql.dialect.oracle.parser.OracleProcedureDataType;
...
//    }
    ...
    @Override
    public void endVisit(com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.wdk.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
