...
import com.wdk.druid.support.json.JSONUtils;
...
public class TableStat {
    ...
    public static class Column {
        ...
        /**
         * 存储着与列相关联的sqlExprHashCodes
         */
        private Set<Long> sqlExprHashCodes = new HashSet<>();

        public void addSqlExprHashCode(Long hash64){
            sqlExprHashCodes.add(hash64);
        }

        public boolean containsSqlExpr(Long hash64){
            return sqlExprHashCodes.contains(hash64);
        }
